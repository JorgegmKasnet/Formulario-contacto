...
Este proyecto es un formulario de contacto estabilizado y moderno construido con HTML, CSS y JavaSctipt. El formulario incluye validaciones de entrada y un mensaje de confirmación al enviar.

## Caracteristicas
-**Estructura HTML**: Una estructura básica y semantica para el formulario de contacto
- **Estilos CSS**: Disño limpio y moderno utlizado CSS
